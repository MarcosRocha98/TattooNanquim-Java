...
public class Solicitacao {
    ...
    private String periodoEscolhido;
    ...
    public String getPeriodoEscolhido() { return periodoEscolhido; }
    public void setPeriodoEscolhido(String periodoEscolhido) { this.periodoEscolhido = periodoEscolhido; }
